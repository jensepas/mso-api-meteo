...
$sql = 'SELECT * FROM reception ORDER BY recep_date_time DESC Limit 1 ';
...
$sql2 = "SELECT * FROM reception WHERE recep_date_time<'" . $date_1 . "' ORDER BY recep_date_time DESC Limit 1 ";
